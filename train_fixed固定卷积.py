...
import os
import numpy as np
from fixed_deblur import FixedDeblurGAN, FixedDeblurLoss
...
def train_fixed_model():
    ...
    output_dir = "training_output_fixed"
    ...
    # 初始化模型
    model = FixedDeblurGAN().to(device)
    criterion = FixedDeblurLoss()
    ...
    # 保存最终模型
    torch.save(model.state_dict(), f"{output_dir}/fixed_deblur_final.pth")
